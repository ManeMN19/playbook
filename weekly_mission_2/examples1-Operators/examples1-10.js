...
const array10 = ['Explorer 1', 1,'Explorer 2',2, 'Explorer 3',3, 'Explorer 4',4]
const areAllStr = names10.every((name) => typeof name === 'string') // every
const areAllStr_1 = array10.every((name) => typeof name === 'string') // every
console.log("Array: "+names10)
console.log("Ejemplo 10: Son todos los nombres string: " + areAllStr)
console.log("\n-------------------------------------------")
console.log("\nArray: "+array10)
console.log("Ejemplo 10: Son todos los nombres string: " + areAllStr_1)