...
class MissionCommander {
  ...
  console.log(`\nEstudiantes antes del Set: ${missionCommanderNode.getStudents}`) // 0 por default
  console.log("Vistas antes del Set: "+missionCommanderNode.getLives)// 0 por default
  
  // actualizamos los atributos por medio de los setters
  missionCommanderNode.setStudents = 100
  missionCommanderNode.setLives = 3
  
  console.log(`\nEstudiantes después del Set: ${missionCommanderNode.getStudents}`) // 0 por default
  console.log("Vistas después del Set: "+missionCommanderNode.getLives)// 0 por default